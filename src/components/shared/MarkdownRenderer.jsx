      ...
      <ReactMarkdown
        ...
        components={{
          ...
          code: ({ children, className, inline }) => {
            ...
            // Block code - don't show language label
            return (
              <div className="my-3">
                <code className="block bg-gray-900 text-gray-100 px-3 py-2 rounded-lg overflow-x-auto text-sm font-mono leading-5 whitespace-pre">
                  {children}
                </code>
              </div>
            );
